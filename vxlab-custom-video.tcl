...
#
# vxlab-custom-video.tcl: Tcl script for re-creating project 'Nexys-Video-HDMI'
#
# Generated by Vivado on Wed Jan 26 22:59:12 -0500 2022
...
#
# 1. This project restoration tcl script (vxlab-custom-video.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "F:/vivado_2018p2_projects/nexys_cust/nexy_cust/vivado_proj/Nexys-Video-HDMI.srcs/sources_1/new/modify_video.v"
#    "F:/vivado_2018p2_projects/nexys_cust/nexy_cust/vivado_proj/Nexys-Video-HDMI.srcs/sources_1/imports/hdl/hdmi_wrapper.v"
#    "F:/vivado_2018p2_projects/nexys_cust/nexy_cust/vivado_proj/Nexys-Video-HDMI.srcs/sources_1/new/invert_rgb.v"
#    "F:/vivado_2018p2_projects/nexys_cust/nexy_cust/vivado_proj/archive_project_summary.txt"
#    "F:/vivado_2018p2_projects/nexys_cust/nexy_cust/vivado_proj/Nexys-Video-HDMI.srcs/sources_1/bd/hdmi/ip/hdmi_mig_7series_0_0/mig_b.prj"
#    "F:/vivado_2018p2_projects/nexys_cust/nexy_cust/vivado_proj/Nexys-Video-HDMI.srcs/constrs_1/imports/constraints/vdma_timing_workaround.xdc"
#    "F:/vivado_2018p2_projects/nexys_cust/nexy_cust/vivado_proj/Nexys-Video-HDMI.srcs/constrs_1/imports/constraints/NexysVideo_Master.xdc"
#
...
set _xil_proj_name_ "vxlab-custom-video"
...
set script_file "vxlab-custom-video.tcl"
...
set orig_proj_dir "F:/vivado_2018p2_projects/nexys_cust/nexy_cust/vivado_proj"
...
set_property -name "board_part_repo_paths" -value "./repo_loc/vxlab-custom-video-repo.board" -objects $obj
...
set_property -name "ip_output_repo" -value "./${_xil_proj_name_}.cache/ip" -objects $obj
...
set_property "ip_repo_paths" "./repo_loc/ip_repo/abc_display_ip_1.0 ./repo_loc/ip_repo/axi_display_control_1.0 ./repo_loc/ip_repo/Nexys-Video-HDMI.ipdefs/repo_0" $obj
...
set files [list \
 "./repo_loc/vxlab-custom-video-repo.srcs/sources_1/new/modify_video.v"\
 "./repo_loc/vxlab-custom-video-repo.srcs/sources_1/imports/hdl/hdmi_wrapper.v"\
 "./repo_loc/vxlab-custom-video-repo.srcs/sources_1/new/invert_rgb.v"\
 "./repo_loc/archive_project_summary.txt"\
 "./repo_loc/vxlab-custom-video-repo.srcs/sources_1/bd/hdmi/ip/hdmi_mig_7series_0_0/mig_b.prj"\
]
...
set file "./repo_loc/vxlab-custom-video-repo.srcs/constrs_1/imports/constraints/vdma_timing_workaround.xdc"
...
# Add/Import constrs file and set constrs file properties
set file "./repo_loc/vxlab-custom-video-repo.srcs/constrs_1/imports/constraints/NexysVideo_Master.xdc"
set file_imported [import_files -fileset constrs_1 [list $file]]
...
if { [get_files modify_video.v] == "" } {
  import_files -quiet -fileset sources_1 ./repo_loc/vxlab-custom-video-repo.srcs/sources_1/new/modify_video.v
}
...
# modify_video
  ...
  if { $bCheckIPs == 1 } {
     set list_check_ips "\ 
  xilinx.com:user:abc_display_ip:1.0\
...
proc create_hier_cell_microblaze_0_local_memory { parentCell nameHier } {
  ...
  # Create instance: modify_video_0, and set properties
  set block_name modify_video
  set block_cell_name modify_video_0
  if { [catch {set modify_video_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $modify_video_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M08_AXI [get_bd_intf_pins abc_display_ip_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M08_AXI]
  ...
  connect_bd_net -net abc_display_ip_0_display_control [get_bd_pins abc_display_ip_0/display_control] [get_bd_pins modify_video_0/display_control]
  connect_bd_net -net axi_dynclk_0_PXL_CLK_5X_O [get_bd_pins axi_dynclk_0/PXL_CLK_5X_O] [get_bd_pins rgb2dvi_0/SerialClk]
  connect_bd_net -net axi_dynclk_0_PXL_CLK_O [get_bd_pins axi_dynclk_0/PXL_CLK_O] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins modify_video_0/clk] [get_bd_pins rgb2dvi_0/PixelClk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tc_0/clk]
  ...
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins abc_display_ip_0/s00_axi_aclk] [get_bd_pins axi_dynclk_0/REF_CLK_I] [get_bd_pins axi_dynclk_0/s00_axi_aclk] [get_bd_pins axi_gpio_video/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins axi_mem_intercon/S03_ACLK] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins microblaze_0_axi_periph/M07_ACLK] [get_bd_pins microblaze_0_axi_periph/M08_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_mig_7series_0_100M/slowest_sync_clk] [get_bd_pins v_tc_0/s_axi_aclk] [get_bd_pins v_tc_1/s_axi_aclk]
  ...
  connect_bd_net -net modify_video_0_hsync_out [get_bd_pins modify_video_0/hsync_out] [get_bd_pins rgb2dvi_0/vid_pHSync]
  connect_bd_net -net modify_video_0_rgb_out [get_bd_pins modify_video_0/rgb_out] [get_bd_pins rgb2dvi_0/vid_pData]
  connect_bd_net -net modify_video_0_video_active_out [get_bd_pins modify_video_0/video_active_out] [get_bd_pins rgb2dvi_0/vid_pVDE]
  connect_bd_net -net modify_video_0_vsync_out [get_bd_pins modify_video_0/vsync_out] [get_bd_pins rgb2dvi_0/vid_pVSync]
  ...
  connect_bd_net -net v_axi4s_vid_out_0_vid_active_video [get_bd_pins modify_video_0/video_active_in] [get_bd_pins v_axi4s_vid_out_0/vid_active_video]
  connect_bd_net -net v_axi4s_vid_out_0_vid_data [get_bd_pins modify_video_0/rgb_in] [get_bd_pins v_axi4s_vid_out_0/vid_data]
  connect_bd_net -net v_axi4s_vid_out_0_vid_hsync [get_bd_pins modify_video_0/hsync_in] [get_bd_pins v_axi4s_vid_out_0/vid_hsync]
  connect_bd_net -net v_axi4s_vid_out_0_vid_vsync [get_bd_pins modify_video_0/vsync_in] [get_bd_pins v_axi4s_vid_out_0/vid_vsync]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A40000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs abc_display_ip_0/S00_AXI/S00_AXI_reg] SEG_abc_display_ip_0_S00_AXI_reg
...
# End of cr_bd_hdmi()
cr_bd_hdmi ""
set_property IS_MANAGED "0" [get_files hdmi.bd ] 
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a200tsbg484-1 -flow {Vivado Implementation 2018} -strategy "Performance_Explore" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
